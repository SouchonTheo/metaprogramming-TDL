...
public class CoupleType implements Type {
	...
	public boolean equalsTo(Type _other) {
		System.out.println("equalsTo de coupleType");
		// Réécrire ca pour tous les autres types similaires
		...
		if (otherType instanceof CoupleType) {
			return this.first.equalsTo(((CoupleType) otherType).first)
					&& this.second.equalsTo(((CoupleType) otherType).second);
		} else {
			System.out.println("equalsTo de coupleType False");
			return false;
		}
	}
	...
	public boolean compatibleWith(Type _other) {
		...
		if (otherType instanceof CoupleType) {
			return this.first.compatibleWith(((CoupleType) otherType).first)
					&& this.second.compatibleWith(((CoupleType) otherType).second);
		} else {
			return false;
		}
	}
